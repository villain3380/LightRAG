...
from lightrag.api.routers.trace_routes import create_trace_routes
from lightrag.api.routers.query_trace_routes import create_query_trace_routes
...
def create_app(args):
    ...
    app.include_router(create_trace_routes(rag))
    app.include_router(create_query_trace_routes(rag, api_key))
