...
- `VALID_DOMAINS = {"financial_market", "financial_market/semiconductor", "financial_market/banking", "financial_market/real_estate", "technology", "policy", "daily_life", "frontend_and_backend", "data_structures_and_algorithms", "other"}`
